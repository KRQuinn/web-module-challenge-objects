...
console.log('task 1a:', createMenuItem('burger', 18, 'sandwhich'));
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(discoType){
    let newPrice = 0;
    if(discoType === 'teacher' || discoType === 'student'){
...
const reviews = [
    ...
    {name: "Aloysius", rating: 5, feedback: "11/5, would do again! Best mistake I ever made!"},
]
